    ...
    render() {
      return (
        <div>
            ...
            <div style={container}>
                <Button variant="outlined" style={{position: 'absolute' , right:'100px' , marginTop: '2%'}}>Edit this job</Button>
                <h1 style={txt1}>Front-end Developer</h1>
                
                <p style={txt1}>At night, when the stars light up my room
                I sit by myself
                Talking to the moon
                ...
                <Button variant="outlined" style={{position: 'absolute',marginLeft:'5%'}}>Apply Now</Button>
